...
class Configs:
    def __init__(self, model_index=6):
        ...
        self.batch_size = 128
        self.lr = 1e-3
        self.lambda_dom = 1e-2
        self.lambda_ent = 1e-2
        self.lambda_div = 1e-3
        self.div_margin = 100
        self.lambda_agree = 1e-3
        self.model_index = model_index
        self.save_path = 'D:/workspace/DA/model/model_{}'.format(self.model_index)
        if not os.path.exists(self.save_path):
            os.makedirs(self.save_path)
        self.mode = 0 # 0 for training, 1 for testing, -1 for fine-tuning
        self.checkpoint = 'D:/workspace/DA/model/model_9/model_best_1_1'
